import '../src/env.js';
import { createAkbarTravelsProvider } from '../src/providers/akbarTravelsProvider.js';
...
const adapter = createAkbarTravelsProvider();

if (!adapter) {
  console.log(JSON.stringify({
    query,
    providerStats: [{ name: 'AkbarTravels.com', status: 'not_configured', offerCount: 0 }],
    rawOfferCount: 0,
    firstOffer: null
  }, null, 2));
} else {
