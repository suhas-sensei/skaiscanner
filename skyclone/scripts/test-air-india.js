import '../src/env.js';
import { createAirIndiaProvider } from '../src/providers/airIndiaProvider.js';
...
const adapter = createAirIndiaProvider();

if (!adapter) {
  console.log(JSON.stringify({
    query,
    providerStats: [{ name: 'Air India', status: 'not_configured', offerCount: 0 }],
    rawOfferCount: 0,
    firstOffer: null
  }, null, 2));
} else {
