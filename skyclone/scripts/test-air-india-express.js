import '../src/env.js';
import { createAirIndiaExpressProvider } from '../src/providers/airIndiaExpressProvider.js';
...
const adapter = createAirIndiaExpressProvider();

if (!adapter) {
  console.log(JSON.stringify({
    query,
    providerStats: [{ name: 'Air India Express', status: 'not_configured', offerCount: 0 }],
    rawOfferCount: 0,
    firstOffer: null
  }, null, 2));
} else {
