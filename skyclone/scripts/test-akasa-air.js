import '../src/env.js';
import { createAkasaAirProvider } from '../src/providers/akasaAirProvider.js';
...
const adapter = createAkasaAirProvider();

if (!adapter) {
  console.log(JSON.stringify({
    query,
    providerStats: [{ name: 'Akasa Air', status: 'not_configured', offerCount: 0 }],
    rawOfferCount: 0,
    firstOffer: null
  }, null, 2));
} else {
